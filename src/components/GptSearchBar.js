...
function GptSearchBar() {
    ...
    const handleGptSearchClick = async () => {
        ...
        const gptQuesry = "act as a indian retro movie  recommondation system  and suggest some movie for the query" + searchText.current.value +
        ...
        const gptResult = await openai.chat.completions.create({
            messages: [{ role: 'user', content: gptQuesry }],
            model: 'gpt-3.5-turbo',
        });
